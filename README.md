...
- `figure_scripts/` — the scripts that regenerate the paper's figures (`generate_fig1_accuracy.py`,
  `generate_fig2_bb_delta.py`, `generate_fig3_ars.py`, `generate_fig4_validation.py`); they write the
  PNGs into `figures/paper_figures/`.
